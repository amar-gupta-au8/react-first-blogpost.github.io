...
import Question from '../../assets/new.png';
        ...
        >
          <Timeline>
            ...
            <div>
              ...
              <h3 className="recognition-text">Special recognition goes to my parents, my better half, and everyone in attainu for making my first 30 days so memorable. I truly look forward to coming to work each day and facing new challenges head on.</h3>
            </div>
         </Timeline>
        </Scene>
      </Controller>
